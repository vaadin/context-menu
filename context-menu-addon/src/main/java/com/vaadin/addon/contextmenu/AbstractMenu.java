...
public class AbstractMenu implements Menu {
	 ...
	 * clicks on the containing {@link com.vaadin.ui.MenuItem}. The
	...
	/* (non-Javadoc)
	 * @see com.example.contextmenu.Menu#addItem(java.lang.String, com.example.contextmenu.AbstractMenu.Command)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.example.contextmenu.Menu#addItem(java.lang.String, com.vaadin.server.Resource, com.example.contextmenu.AbstractMenu.Command)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.example.contextmenu.Menu#addItemBefore(java.lang.String, com.vaadin.server.Resource, com.example.contextmenu.AbstractMenu.Command, com.example.contextmenu.AbstractMenu.MenuItem)
	 */
	@Override
	public MenuItem addItemBefore(String caption, Resource icon, Command command,
	...
	/* (non-Javadoc)
	 * @see com.example.contextmenu.Menu#removeItem(com.example.contextmenu.AbstractMenu.MenuItem)
	 */
	@Override
