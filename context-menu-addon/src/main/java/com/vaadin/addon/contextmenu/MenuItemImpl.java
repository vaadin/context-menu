...
class MenuItemImpl implements Serializable, MenuItem {
	...
	private MenuItem addItem(boolean separator, String caption, Resource icon, Command command)
			throws IllegalStateException {
		if (isSeparator()) {
	...
	private MenuItem addItemBefore(boolean separator, String caption, Resource icon,
			Command command, MenuItem itemToAddBefore)
			throws IllegalStateException {
		if (isCheckable()) {
			throw new IllegalStateException(
	 ...
	 * 
	 * @see
	 * com.example.contextmenu.menubar.MenuItem#setCommand(com.example.contextmenu
	 ...
	 * 
	 * @see
	 * com.example.contextmenu.menubar.MenuItem#setIcon(com.vaadin.server.Resource
	 * )
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.example.contextmenu.menubar.MenuItem#removeChild(com.example.contextmenu
	 * .menubar.MenuItem)
	 */
	@Override
